...
def main():
    ...
    folder = "./Human_Mouse/0_m_exon_score/m_result_1000"
    txt_folder = "./Human_Mouse/0_m_exon_score/m_result_1000"
    ...
    sns.swarmplot(
        ...
        palette={"SE": "red", "non-SE": "black"},
        dodge=False, size=7, linewidth=0
    )
    ...
    plt.tight_layout()
    plt.savefig("./SE_result/SE_m_k.png", dpi=300)
    plt.show()
...
#     ax1.set_ylabel("Exon Score", fontsize=25)
...
#     ax2.set_xlabel("Exon Score", fontsize=25)
...
#     plt.tight_layout()
#     plt.savefig("./SE_result/SE_m.png", dpi=300)
#     plt.show()
