...
def main():
    ...
    folder = "./Human_Mouse/0_h_exon_score/h_result_1000"
    txt_folder = "./Human_Mouse/0_h_exon_score/h_result_1000"
    ...
    plt.tight_layout()
    plt.savefig("./SE_result/SE_h_k.png", dpi=300)
    plt.show()
