...
def main():
    ...
    a5_df = pd.read_csv("./data/mm10_A5.txt", sep="\t")
    a5_df["index"]    = -1
    a5_df["prob_5ss"] = -1.0
    a5_df["prob_3ss"] = -1.0
    ...
    ax2.legend(
        ...
        bbox_to_anchor=(-0.4, 1.08),  # 往上移一點（y > 1）
        fontsize=40,
        frameon=False
    )
    ...
    plt.tight_layout()
    plt.savefig("./A5_result/A5_m_k.png", dpi=300)
    plt.show()
    print(f"r = {r:.2f}\n(p = {p:.2g})")
...
#         handles=custom_legend,
#         loc='upper left',  # 基準點是左上角
#         bbox_to_anchor=(-0.2, 1.029),  # 往上移一點（y > 1）
#         fontsize=20,
#         frameon=False
#     )
...
#     plt.tight_layout()
#     plt.savefig("./A5_result/A5_m.png", dpi=300)
#     plt.show()
