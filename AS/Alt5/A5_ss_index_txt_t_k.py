...
def main():
    ...
    plt.tight_layout()
    plt.savefig("./A5_result/A5_t_k.png", dpi=300)
    plt.show()
    print(f"r = {r:.2f}**\n(p = {p:.2g})")
...
#         handles=custom_legend,
#         loc='upper left',  # 基準點是左上角
#         bbox_to_anchor=(-0.1, 1.035),  # 往上移一點（y > 1）
#         fontsize=20,
#         frameon=False
#     )
...
#     #         plt.Line2D([0],[0], marker='o', color='w', label="Minor", markerfacecolor='orange', markersize=8)
#     #     ],
#     #     title="Event", loc="lower left", fontsize=10
#     # )

#     plt.tight_layout()
#     plt.savefig("./A5_result/A5_k.png", dpi=300)
#     plt.show()
