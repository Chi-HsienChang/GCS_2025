...
def main():
    ...
    folder = "./Human_Mouse/0_h_intron_score/h_result_1000"
    txt_folder = "./Human_Mouse/0_h_intron_score/h_result_1000"
    ...
    sns.swarmplot(
        ...
        palette={"RI": "red", "non-RI": "black"},
        dodge=False, size=6, linewidth=0
    )
...
# 在 legend 裡，只顯示 marker
    ...
    plt.tight_layout()
    plt.savefig("./RI_result/RI_h_k.png", dpi=300)
    plt.show()
