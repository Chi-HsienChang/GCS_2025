...
def main():
    ...
    folder = "./Human_Mouse/0_m_intron_score/m_result_1000"
    txt_folder = "./Human_Mouse/0_m_intron_score/m_result_1000"
    ...
    sns.swarmplot(
        ...
        palette={"RI": "red", "non-RI": "black"},
        dodge=False, size=3, linewidth=0
    )
    ...
    ax2.plot(x_ri, cdf_ri, label="RI", color="red", linewidth=12)
    ax2.plot(x_nonri, cdf_nonri, label="non-RI", color="black", linewidth=12)
...
# 在 legend 裡，只顯示 marker
    ...
    plt.tight_layout()
    plt.savefig("./RI_result/RI_m_k.png", dpi=300)
    plt.show()
...
# #     )
# #     ax1.set_xlabel("Classification", fontsize=15)
# #     ax1.set_ylabel("Intron Score", fontsize=15)
# #     ax1.tick_params(axis='x', labelsize=15)  # 將 x 軸刻度字型大小設為 15
# #     ax1.tick_params(axis='y', labelsize=15)  # 將 x 軸刻度字型大小設為 15
...
# #     ax2.set_xlabel("Intron Score", fontsize=15)
# #     ax2.set_ylabel("eCDF", fontsize=15)
# #     ax2.set_xlim(0, 1)
# #     ax2.set_xticks([0.0, 0.5, 1.0])
# #     ax2.tick_params(axis='x', labelsize=15)  # 將 x 軸刻度字型大小設為 15
# #     ax2.tick_params(axis='y', labelsize=15)  # 將 x 軸刻度字型大小設為 15
# #     ax2.legend(fontsize=15)

# #     plt.tight_layout()
# #     plt.savefig("./RI_result/RI_m.png", dpi=300)
# #     plt.show()
...
#         dodge=False, size=4, linewidth=0
#     )
#     ax1.set_xlabel("Classification", fontsize=25)
#     ax1.set_ylabel("Intron Score", fontsize=25)
#     ax1.tick_params(axis='x', labelsize=25)  # 將 x 軸刻度字型大小設為 15
#     ax1.tick_params(axis='y', labelsize=25)  # 將 x 軸刻度字型大小設為 15
...
#     ax2.plot(x_ri, cdf_ri, label="RI", color="red", linewidth=2)
#     ax2.plot(x_nonri, cdf_nonri, label="non-RI", color="black", linewidth=2)
#     ax2.set_xlabel("Intron Score", fontsize=25)
#     ax2.set_ylabel("eCDF", fontsize=25)
#     ax2.set_xlim(0, 1)
#     ax2.set_xticks([0.0, 0.5, 1.0])
#     ax2.tick_params(axis='x', labelsize=25)  # 將 x 軸刻度字型大小設為 15
#     ax2.tick_params(axis='y', labelsize=25)  # 將 x 軸刻度字型大小設為 15
