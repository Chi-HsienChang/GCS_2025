...
# -*- coding: utf-8 -*-
"""
Compute exon-score statistics and plot a merged box + strip plot across species.
Two boxes per species (TP vs. FP) with narrow widths for extra gap
and a custom point legend on top with rotated x-labels.
"""
    ...
    for top_k in tqdm(top_ks, desc="top_k", leave=False):
        for code, species in species_map.items():
            ...
            for fname in files:
                ...
                # parse annotated and SMsplice sets
                    ...
                    if line and line[0].isdigit():
                        ...
                        if len(parts) >= 3:
                            try:
                                ...
                                pass
                # build pairs for exon predictions
