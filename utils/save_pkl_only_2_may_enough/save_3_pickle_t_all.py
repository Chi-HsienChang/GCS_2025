...
# Get training, validation, generalization, and test
...
with open(f't_pred_all_new_{my_seed}.pkl', 'wb') as f:
    pickle.dump(data, f)
...
with open(f't_predictions_new_{my_seed}.pkl', 'wb') as f:
    pickle.dump(data, f)
...
# 將字典儲存到 pickle 檔案
with open(f't_new_{my_seed}.pkl', 'wb') as f:
    pickle.dump(data, f)
